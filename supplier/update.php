                ...
                <form class="form-horizontal" action='<?php $_SERVER['PHP_SELF']; ?>' method="post">
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama_supplier" name="nama_supplier" placeholder="Nama" required value='<?php echo $row['nama_supplier']; ?>'>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="kota" class="col-sm-3 col-form-label">Kota</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="kota" name="kota" placeholder="Kota" required value='<?php echo $row['kota']; ?>'>
                      </div>
                    </div>
                  </div>
                  <!-- /.card-body -->
                  <div class="card-footer">
                    <button type="submit" class="btn btn-info float-right" name='update'>Edit Data Supplier</button>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
