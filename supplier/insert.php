              ...
              <form class="form-horizontal" action='<?php $_SERVER['PHP_SELF']; ?>' method="post">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="nama_supplier" name="nama_supplier" placeholder="Nama" required>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info float-right" name='input'>Tambah Data Supplier</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
